        ...
        <div className="content-info">
          ...
          <div className="info-container">
            ...
            <p className="content-message">
              ...
              self-teaching React where I am learning how to use things such as
              const, let, mapping, React Hooks, useState, useEffect, props,
              useRef, React Router and more within components and eventually,
              state management through useContext and Redux as well as Axios to
              work with APIs.
            </p>
